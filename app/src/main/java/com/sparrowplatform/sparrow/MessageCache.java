...
public class MessageCache<K, V> implements Map<K, V> {
     ...
     */
    public MessageCache(int timeToLive) {
     ...
     */
    public MessageCache(int timeToLive, int expirationInterval) {
        this(new ConcurrentHashMap<K, ExpiringObject>(),
                new CopyOnWriteArrayList<ExpirationListener<V>>(), timeToLive,
                expirationInterval);
    }

    private MessageCache(ConcurrentHashMap<K, ExpiringObject> delegate,
